...
export type TaskWhereInput = {
  ...
  idTask?: Prisma.IntFilter<"Task"> | number
...
export type TaskScalarWhereWithAggregatesInput = {
  ...
  idTask?: Prisma.IntWithAggregatesFilter<"Task"> | number
}
...
export type TaskUncheckedUpdateInput = {
  ...
  idTask?: Prisma.IntFieldUpdateOperationsInput | number
}
...
export type TaskOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"title" | "description" | "icon" | "status" | "authorId" | "idTask", ExtArgs["result"]["task"]>
...
export interface TaskDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const taskWithTitleOnly = await prisma.task.findMany({ select: { title: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Tasks and only return the `title`
   * const taskWithTitleOnly = await prisma.task.createManyAndReturn({
   *   select: { title: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Tasks and only return the `title`
   * const taskWithTitleOnly = await prisma.task.updateManyAndReturn({
   *   select: { title: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface TaskFieldRefs {
  ...
  readonly idTask: Prisma.FieldRef<"Task", 'Int'>
}
